...
final class HttpRequest2 implements Runnable {
    ...
    final static EnumMap<StatusCode2, String> SCODES = new EnumMap<StatusCode2, String>(StatusCode2.class);

    static {
        CONTENT_TYPES.setProperty("html", "text/html");
        CONTENT_TYPES.setProperty("jpeg", "image/jpeg");

        SCODES.put(StatusCode2.OK, "200");
        SCODES.put(StatusCode2.BAD_REQUEST, "400");
        SCODES.put(StatusCode2.FORBIDDEN, "403");
        SCODES.put(StatusCode2.NOT_FOUND, "404");

        SCODES.put(StatusCode2.HTTP_VERSION_NOT_SUPPORTED, "505");
    }
    ...
    private void sendHeaderLines(DataOutputStream os) throws Exception {
        ...
        if (code == StatusCode2.OK) {
            ...
            contentTypeLine += contentType(requestedFile.getName()) + CRLF; //mission 7
        }
    ...
    private String parseRequestLine(java.lang.String requestLine) {
        ...
        //Modify to your path
//        fileName = "." + fileName ;
        fileName = "/Users/jason/Projects/ComputerNetworkProject/src/html_practice/" + fileName;
        ...
        if (file.isDirectory()) {
            ...
            if (list == null || list.length == 0) {
                ...
                code = StatusCode2.INTERNAL_SERVER_ERROR;
        ...
        if (!version.equals("HTTP/1.0") && !version.equals("HTTP/1.1")) {
            code = StatusCode2.HTTP_VERSION_NOT_SUPPORTED;
